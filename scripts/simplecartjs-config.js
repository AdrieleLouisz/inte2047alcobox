simpleCart({
    ...
    taxRate: .10, // Set a tax rate to reflect the Australian GST rate of 10%.
    cartColumns: [
    ...
    checkout: { 
        ...
        url: "https://saturn.csit.rmit.edu.au/~e46281/inte2047/processFormData.php"
        },
});

/* 
   Add HTML Form data from "checkout.html" to simpleCartJS's "data" variable and submit to server.
 */
