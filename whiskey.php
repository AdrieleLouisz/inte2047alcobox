...
<body>
    ...
    <div class="page">
        ...
        <div class="left-column">
            <img class="item_image product_image" src="images/whiskey-box.jpg" alt="Whiskey Box">
        </div>
        <div class="right-column">

            <div class="product-description">
                
                <h1 class="item_name">Whiskey Box</h1>
                
                <p>Beomgyu likes Whiskey. So you should too!</p>
                <p>
