...
<body>
    ...
    <div class="page">
        ...
        <div class="left-column">
            <img class="item_image product_image" src="images/spirits-box.jpg" alt="Spirits Box">
        </div>
        <div class="right-column">

            <div class="product-description">
                
                <h1 class="item_name">Spirits Box</h1>
                
                <p>Soobin likes Spirits, like Soju. So you should too!</p>
                <p>
