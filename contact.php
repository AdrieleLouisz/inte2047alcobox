...
<body>
    ...
    <div class="page">
        ...
        <div>
            <h1>Contact Us</h1>
            <p>
            <form action="processformdata.php" method="get">
                    ...
                    <input type="text" id="product" name="order_number" />
                    <br />
              
                    <label for="comments">Comments</label>
                    <textarea id="comments" name="user_comments" cols="30" rows="10">Enter comments to seller here.</textarea>
                    <br />
